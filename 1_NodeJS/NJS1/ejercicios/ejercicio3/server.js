...
const server = createServer(async (req, res) => {
  ...
  <html lang="es">
    <head>
      ...
      <title>Node.js | Ejercicio 3</title>
      ...
      <main class="dashboard-container">
        <header class="header">
          <div class="header-info">
            <h1>Ejercicio 3</h1>
            <p>Funciones Exportadas en <strong>Puerto ${PORT}</strong></p>
          </div>
        </header>
        ...
        <section class="terminal-card" aria-label="Salida de consola">
          <div class="terminal-header">
            ...
            <span class="terminal-title">bash — node ejercicio3.js</span>
          </div>
          <div class="terminal-body">
            ${resultadosEjercicio3.map((operacion) => `<p>${operacion.resultado}</p>`).join("")}
          </div>
        </section>
      </main>
