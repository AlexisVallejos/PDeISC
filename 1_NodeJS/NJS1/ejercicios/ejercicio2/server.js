...
const server = createServer(async (req, res) => {
  ...
  <html lang="es">
    <head>
      ...
      <title>Node.js | Ejercicio 2</title>
      ...
      <main class="dashboard-container">
        <header class="header">
          <div class="header-info">
            <h1>Ejercicio 2</h1>
            <p>Calculadora Simple en <strong>Puerto ${PORT}</strong></p>
          </div>
        </header>
        ...
        <section class="terminal-card" aria-label="Salida de consola">
          <div class="terminal-header">
            ...
            <span class="terminal-title">bash — node ejercicio2.js</span>
          </div>
          <div class="terminal-body">
            ${resultadosEjercicio2.map((operacion) => `<p>${operacion.resultado}</p>`).join("")}
          </div>
        </section>
      </main>
