...
const server = createServer(async (req, res) => {
  ...
  <html lang="es">
    <head>
      ...
      <title>Node.js | Ejercicio 4</title>
      ...
      <main class="dashboard-container">
        <header class="header">
          <div class="header-info">
            <h1>Ejercicio 4</h1>
            <p>Módulos Externos en <strong>Puerto ${PORT}</strong></p>
          </div>
        </header>
        ...
        <section class="terminal-card" aria-label="Salida de consola">
          <div class="terminal-header">
            ...
            <span class="terminal-title">bash — node ejercicio4.js</span>
          </div>
          <div class="terminal-body">
            ${resultadosEjercicio4.map((operacion) => `<p>${operacion.expresion} = ${operacion.resultado}</p>`).join("")}
          </div>
        </section>
      </main>
