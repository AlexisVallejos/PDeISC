/**
 * Servidor estático del Proyecto 2 (Inventario Deportivo).
 *
 * Qué hace:
 *  - Levanta un servidor HTTP nativo (sin Express) en el puerto 4002.
 ...
 *  - El array de inventario y todos los métodos de almacenaje (push, unshift,
 *    splice, índice) viven en el navegador (public/js/inventario.js). El
 *    server solo entrega los archivos estáticos.
 */
