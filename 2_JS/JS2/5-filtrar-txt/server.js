/**
 * Servidor estatico para Filtrar TXT.
 *
 * Sirve public/ y guarda una copia del archivo filtrado en archivos-servidor/
 * cuando el navegador descarga el resultado.
 */
...
function normalizarNombreArchivo(nombreArchivo) {
    const nombre = path.basename(String(nombreArchivo || "numeros-filtrados.txt"));
...
server.listen(PORT, () => {
    console.log(`Proyecto Filtrar TXT iniciado en http://localhost:${PORT}`);
});
